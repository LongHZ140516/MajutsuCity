...
class LayoutDataset(Dataset):
    def __init__(self, data_file,is_height, prompt, image_size=(1024, 512), drop_prompt_ratio=0):
        self.data = []
    ...
    def __getitem__(self, idx):
        ...
        if os.path.splitext(source_filename)[1] == '.pkl':
            ...
            if self.is_height == False:
                source = np.zeros((self.image_size[1], self.image_size[0], 3), dtype=np.uint8)
